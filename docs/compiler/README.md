...
`ClassFileStructure` Builder is a builder class for class file structure definition.
...
| `setExceptionTable(ExceptionTable[])` | Define an exception tables to be thrown. This is **not implemented** yet. |
