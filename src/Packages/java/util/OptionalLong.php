...
// use PHPJava\Packages\java\util\stream\LongStream;

/**
 * The `OptionalLong` class was auto generated.
 *
 * @parent \PHPJava\Packages\java\lang\_Object
 */
class OptionalLong extends _Object // implements Supplier, Runnable, LongStream
{
    /**
     ...
     *
     * @see https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/package-summary.html#getAsLong
     * @param null|mixed $a
     * @throws NotImplementedException
     */
    public function getAsLong($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
