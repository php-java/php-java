...
/**
 * The `Random` class was auto generated.
 *
 * @parent \PHPJava\Packages\java\lang\_Object
 */
class Random extends _Object // implements Serializable, DoubleStream
{
    /**
     ...
     * @throws NotImplementedException
     */
    protected function next($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
     ...
     *
     * @see https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/package-summary.html#nextGaussian
     * @param null|mixed $a
     * @throws NotImplementedException
     */
    public function nextGaussian($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
     ...
     *
     * @see https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/package-summary.html#setSeed
     * @param null|mixed $a
     * @throws NotImplementedException
     */
    public function setSeed($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
}
