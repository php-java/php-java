...
/**
 * The `OptionalDouble` class was auto generated.
 *
 * @parent \PHPJava\Packages\java\lang\Object_
 */
class OptionalDouble extends Object_ // implements Supplier, Runnable, DoubleStream
{
    /**
     ...
     *
     * @see https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/package-summary.html#getAsDouble
     * @param null|mixed $a
     * @throws NotImplementedException
     */
    public function getAsDouble($a = null)
    {
        throw new NotImplementedException(__METHOD__);
    }
